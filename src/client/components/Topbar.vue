  ...
  <div class="topbar" v-bind:class="{ absolute: absolute, noborder: !border, expanded: !accordionOpen }">
    <div class="topbar-row">
      ...
      <div class="information" v-if="!hide">
        <div>
          <router-link v-if="!$store.state.logged" :to="{name: 'Login'}">Login</router-link>
        </div>
        <div>
      ...
      <div class="accordian" v-if="!hide">
        <i v-if="!accordionOpen" class="fas fa-bars" @click="accordionOpen = true"></i>
        <i v-else class="fas fa-times" @click="accordionOpen = false"></i>
      </div>
    </div>
    <div v-if="accordionOpen" class="accordian-links">
      <div>
        <router-link v-if="!$store.state.logged" :to="{name: 'Login'}">Login</router-link>
      </div>
      <div>
